...
from server_model.selector.aio_base_task_selector import AioBaseTaskSelector


class AioTrainingTaskSelector(AioBaseTaskSelector):
    @classmethod
    async def where(cls, impl_cls, where: str, args: Tuple, limit: int, order_desc: bool = True) -> List[TrainingTask]:
        """
        @note: 我只拿 1000 条实验
